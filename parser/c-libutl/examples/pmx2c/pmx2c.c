...
static char *pmx_1 = 
  /*   1 */ "&:\002""/*""&|"
  /*   2 */ "&:\005""&e\\&q""&|"
  /*   3 */ "&:\023""switch&spmx&S(&b())""&|"
  /*   4 */ "&:\022""case&s&e\\(&b\"\")&S:";
static char *pmx_2 = 
  /*   1 */ "&:\002""*/";

#define pmx_switch(s,n) switch ((pmx_cur=s, (pmx_ret=pmxMatchStr(s,n)), (s)+=pmxLen(pmx_ret,0), pmxMatched(pmx_ret)))

#define pmx_Start(x) (pmx_cur+pmxStart(pmx_ret,x))
#define pmx_End(x)   (pmx_cur+pmxEnd(pmx_ret,x))
#define pmx_Len(x)    pmxLen(pmx_ret,x)
#define pmx(w,n)      pmx_##w(n)
